...
export function TextCommon(props: React.PropsWithChildren<TextProps>) {
    const {
        fontSize,
        fontWeight,
        lineHeight,
    ...
    }, [maxLines, fontSize, fontWeight, lineHeight, textAlign, color, display, whiteSpace, overflow, textOverflow, textTransform, letterSpacing, textDecoration, fontStyle, maxWidth, cursor]);
