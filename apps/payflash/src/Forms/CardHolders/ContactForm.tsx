...
import { AvatarField, FlexBox, FormikForm, InputField, SelectField, TextCommon, } from '@my-monorepo/ui';
                                                ...
                                                formik.values.socialContacts.map((_, index) => (
                                                    <FlexBox key={index} gap={8} >
                                                        ...
                                                        <Button
                                                            ...
                                                            icon={<ICSocial.Trash/>}
                                                            style={{ display: 'flex', alignSelf: 'center', justifyContent: 'center', alignItems:'center' }}
                                                        />
                                                    </FlexBox>
                                                ))
                                            ) }
                                            <Button icon={<PlusOutlined />} onClick={() => arrayHelpers.push({})} >Add social</Button>
                                        </FlexBox>
                                    )}
                                />
                        </Card>
